...
uint32_t require(const v8::Local<v8::Object>& obj, const char* key)
{
...
Options extract_options(const v8::Local<v8::Object>& options)
{
    ...
    ret.hash_length = require(options, "hashLength");
    ret.time_cost = require(options, "timeCost");
    ret.memory_cost = require(options, "memoryCost");
    ret.parallelism = require(options, "parallelism");
    ret.version = require(options, "version");
    ret.type = static_cast<argon2_type>(require(options, "type"));
    return ret;
}
